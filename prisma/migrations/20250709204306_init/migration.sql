...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'CANCEL_REQUESTED');
...
CREATE TABLE "User" (
    ...
    "preferences" JSONB DEFAULT '{"language": "vi", "favoriteCategories": [], "notificationSettings": {"sms": false, "email": true}}',
